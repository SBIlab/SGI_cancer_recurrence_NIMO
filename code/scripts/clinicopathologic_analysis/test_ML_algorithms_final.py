...
def import_immune_cell_proportion(reference_set):
	if reference_set == 'LM22':
		fi_dir = '/data/user/junghokong/co_work/SGI_CRC_seq/result/2_transcriptome_analysis/CIBERSORT/CIBERSORT_retrorespective_114_samples.txt'
	elif reference_set == 'ensgene_TM_signature':
		fi_dir = '/data/user/junghokong/co_work/SGI_CRC_seq/result/3_transcriptome_methylome_signature_comparison/CIBERSORT/ensgene_string_network_LM22.txt'
	elif reference_set == 'FANTOM_TM_signature':
		fi_dir = '/data/user/junghokong/co_work/SGI_CRC_seq/result/3_transcriptome_methylome_signature_comparison/CIBERSORT/FANTOM_string_network_LM22.txt'
	elif reference_set == 'FANTOM_TM_signature_no_network':
		fi_dir = '/data/user/junghokong/co_work/SGI_CRC_seq/result/3_transcriptome_methylome_signature_comparison/CIBERSORT/FANTOM_LM22.txt'
	elif reference_set == 'methylCIBERSORT':
		fi_dir = '/data/user/junghokong/co_work/SGI_CRC_seq/result/2_transcriptome_analysis/CIBERSORT/MethylCIBERSORT_retrospective_recurrent_info_updated_20200121_DHK.txt'
...
n_jobs = 10
test_type = 'clinical_TNM_only' # 'all_TNM_only', 'clinical_TNM_only', 'immune_only'
...
# print output
output.to_csv('/data/user/junghokong/co_work/SGI_CRC_seq/FINAL_cross_validation_performance_%s.txt'%(test_type), index=False, sep='\t')
