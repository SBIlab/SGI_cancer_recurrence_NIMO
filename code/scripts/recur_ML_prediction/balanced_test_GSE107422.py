...
references = ['LM22', 'FANTOM_TM_signature_no_network', 'FANTOM_TM_signature']   #, 'LM22', 'FANTOM_TM_signature_no_network', 'methylCIBERSORT'] #'FANTOM_TM_signature' #
...
# print output
output_df.to_csv(
    '%s/FINAL_cross_validation_performance_balanced_sample_%s.txt' % (fo_dir,test_type), index=False, sep='\t')
