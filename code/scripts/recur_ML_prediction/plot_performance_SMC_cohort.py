...
fi_dir = "../../result/SMC_cohort"



## load data
adf = pd.read_csv('%s/FINAL_cross_validation_performance_SMC_cohort_all_TNM_only.txt'%fi_dir, sep='\t')
cdf = pd.read_csv('%s/FINAL_cross_validation_performance_SMC_cohort_clinical_TNM_only.txt'%fi_dir, sep='\t')
idf = pd.read_csv('%s/FINAL_cross_validation_performance_SMC_cohort_immune_only.txt'%fi_dir, sep='\t')
